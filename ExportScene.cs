...
public class ExportScene : ScriptableObject
{
    ...
    private static float autoCutMinX = 4097;
    private static float autoCutMaxX = 0;
    private static float autoCutMinY = 4097;
    private static float autoCutMaxY = 0;

    private static float cutMinX = 4097;
    private static float cutMaxX = 4097;
    private static float cutMinY = 4097;
    private static float cutMaxY = 4097;
